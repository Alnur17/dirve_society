import 'package:dirve_society/app/modules/profile/model/my_club_model.dart';
...
class MyClubController extends GetxController {
  ...
  Future<bool> getMyClub() async {
    ...
    if (response.isSuccess) {
      ...
      _myClubModel = MyClubModel.fromJson(response.responseData);
